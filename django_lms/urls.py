...
admin.site.site_header = 'ApniPaathshala Admin'
admin.site.site_title = 'ApniPaathshala Admin pannel'
admin.site.index_title = 'Welcome to ApniPaathshala Admin pannel'

urlpatterns = [
    url(r'^$', project_views.index, name="home"),
    
    url(r'^about/', project_views.about, name="about"),
    ...
    url(r'^mycourse/(?P<pk>[-\w]+)/$',
        project_views.mycourse.as_view(), name="mycourse"),
